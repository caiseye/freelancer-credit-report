...
const NORMAL = {
  ...
  short: "기준 케이스",
  tone: "green",
  desc: "51개월 무중단 · 이상거래 없음 · DSR 여유. 지표 대부분이 기준선 안쪽인 표준 흐름이에요.",
...
const FDS_ALERT = {
  ...
  short: "FDS 적중",
  tone: "red",
  desc: "고액 현금인출·순환거래·가장입금이 함께 잡힌 케이스. 위험 3건·확인 4건으로 소명이 필요해요.",
...
const INCOME_DOWN = {
  ...
  short: "우하향 추세",
  tone: "amber",
  desc: "12개월간 소득이 3분의 1로 줄어든 케이스. 예측도 우하향이라 상환 재원이 줄어드는 흐름이에요.",
...
const HIGH_DSR = {
  ...
  short: "DSR 초과",
  tone: "red",
  desc: "소득은 안정적인데 기존 대출 원리금이 연소득의 절반을 넘어요. 규제 기준선 대비 여력이 남지 않은 상태예요.",
